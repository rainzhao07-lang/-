...
import premiumQuestionsJson from "@/content/premiumQuestions.json";
import questionsJson from "@/content/questions.json";
import type { BreedProfile, Persona, PremiumQuestion, Question } from "./types";
...
export const premiumQuestions = premiumQuestionsJson as unknown as PremiumQuestion[];
